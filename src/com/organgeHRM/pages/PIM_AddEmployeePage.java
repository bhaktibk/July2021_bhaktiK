...
public class PIM_AddEmployeePage extends Predefined {
	...
	public PIM_AddEmployeePage setWorkShift(String shiftValue) {
		 ...
		 * "//div[@id='work_shift_id_inputfileddiv']//span[@class='caret']//following-sibling::input"
		 * )).click();
		 * driver.findElement(By.xpath("//span[text()='"+shift+"']")).click(); return
		 * this;
		 */
	...
	public PIM_AddEmployeePage setTemporaryDep(String dep) {
		// driver.findElement(By.xpath("//label[text()='Temporary
		// Department']//preceding-sibling::div/span[@class='caret']")).click();
		// driver.findElement(By.xpath("//li/span[text()='"+dep+"']")).click();
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement deptDropDown = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//label[text()='Temporary Department']//preceding-sibling::div")));
		// scrolling
		deptDropDown.click();

		WebElement regionElement = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li/span[text()='" + dep + "']")));
		regionElement.click();
		return this;
	}
